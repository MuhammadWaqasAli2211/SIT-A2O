 ...
 *
 * lucide-react removed brand icons, so these are defined locally rather than
 * pulling in a second icon package for four glyphs. All use `currentColor`
 * so they inherit hover and theme colours like any other icon.
 */
